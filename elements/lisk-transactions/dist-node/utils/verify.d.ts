...
export declare const verifyBalance: (id: string, account: Account, amount: BigNum) => TransactionError;
export declare const verifyAmountBalance: (id: string, account: Account, amount: BigNum, fee: BigNum) => TransactionError;
