...
try {
	...
	app_1.registerTransaction(
		TRANSACTION_TYPES.DAPP,
		transactions_1.DappTransaction,
		{
	...
	app_1.registerTransaction(
		...
		transactions_1.InTransferTransaction,
		{
			matcher: function(context) {
				return (
					context.blockHeight <
	...
	app_1.registerTransaction(
		...
		transactions_1.OutTransferTransaction,
		{
			matcher: function(context) {
				return (
					context.blockHeight <
	...
	app_1
		.run()
		.then(function() {
			return app_1.logger.info('App started...');
		})
