...
export declare const encryptMessage: ({
	message,
	passphrase,
	recipient,
...
export declare const decryptMessage: ({
	cipher,
	nonce,
	passphrase,
	senderPublicKey,
...
export declare const encryptPassphrase: ({
	passphrase,
	password,
...
export declare const decryptPassphrase: ({
	encryptedPassphrase,
	password,
...
export declare const getAddressFromPublicKey: (
	publicKey: string,
) => {
...
export declare const signMessage: ({
	message,
	passphrase,
...
export declare const verifyMessage: ({
	publicKey,
	signature,
	message,
}: VerifyMessageInputs) => {
