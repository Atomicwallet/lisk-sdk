...
var removeANSIFromObject = function (object) {
    return Object.entries(object).reduce(function (strippedResult, _a) {
        ...
        var _c;
        return (tslib_1.__assign({}, strippedResult, (_c = {}, _c[key] = strip_ansi_1.default(value), _c)));
    }, {});
};
var isStringMapArray = function (result) { return Array.isArray(result); };
...
exports.print = function (_a) {
    var _b = _a === void 0 ? {} : _a, json = _b.json, pretty = _b.pretty;
