...
exports.isCacheRunning = function (installDir, name) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, worker_process_1.exec(REDIS_CLI + " -p " + redisPort + " ping", { cwd: installDir })];
            case 2:
...
exports.startCache = function (installDir, name) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var redisPort, stderr;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, pm2_1.describeApplication(name)];
            case 1:
                redisPort = (_a.sent()).redisPort;
                return [4, worker_process_1.exec(REDIS_BIN + " " + REDIS_CONFIG + " --port " + redisPort, { cwd: installDir })];
            case 2:
                stderr = (_a.sent()).stderr;
                if (!stderr) {
...
var stopCommand = function (installDir, network, name) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                redisPort = (_a.sent()).redisPort;
                if (password) {
                    return [2, REDIS_CLI + " -p " + redisPort + " -a " + password + " shutdown"];
                }
...
exports.stopCache = function (installDir, network, name) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
exports.isCacheEnabled = function (installDir, network) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var enabled, error_3;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
