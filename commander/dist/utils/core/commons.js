...
exports.isSupportedOS = function () { return os.type() in constants_1.OS; };
...
exports.getVersionToInstall = function (network, version) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2: return [2, version];
        }
    });
}); };
exports.backupLisk = function (installDir) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var stderr;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fs_extra_1.default.emptyDirSync(config_1.defaultBackupPath);
                return [4, worker_process_1.exec("mv -f " + installDir + " " + config_1.defaultBackupPath)];
            case 1:
...
exports.upgradeLisk = function (installDir, name, network, currentVersion) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, worker_process_1.exec(installDir + "/bin/node " + installDir + "/scripts/update_config.js --network " + network + " --output " + installDir + "/config.json " + LISK_BACKUP + "/config.json " + currentVersion)];
            case 1:
                stderr = (_a.sent()).stderr;
                if (stderr) {
                    throw new Error(stderr);
...
exports.validateVersion = function (network, version) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var url, error_1;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!semver_1.default.valid(version)) {
                    throw new Error("Upgrade version: " + version + " has invalid format, Please refer version from release url: " + constants_1.RELEASE_URL + "/" + network);
                }
            ...
            case 3:
                ...
                if (error_1.message === 'Request failed with status code 404') {
                    throw new Error("Upgrade version: " + version + " doesn't exists in " + constants_1.RELEASE_URL + "/" + network);
                }
...
exports.getSemver = function (str) {
    var exp = new RegExp(/(?:0|[1-9]\d*)\.(?:0|[1-9]\d*)\.(?:0|[1-9]\d*)(?:-(?:[1-9]\d*|[\da-z-]*[a-z-][\da-z-]*)(?:\.(?:[1-9]\d*|[\da-z-]*[a-z-][\da-z-]*))*)?\.?(?:0|[1-9]\d*)?/);
...
exports.generateEnvConfig = function (network) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                instances = _a.sent();
                filteredByNetwork = instances.filter(function (i) { return i.network === network; });
                return [2, {
                        LISK_DB_PORT: getEnvByKey(instances, 'dbPort', constants_1.POSTGRES_PORT) + 1,
                        LISK_REDIS_PORT: getEnvByKey(instances, 'redisPort', constants_1.REDIS_PORT) + 1,
                        LISK_HTTP_PORT: getEnvByKey(filteredByNetwork, 'httpPort', constants_1.HTTP_PORTS[network]) +
                            INCREMENT,
                        LISK_WS_PORT: getEnvByKey(filteredByNetwork, 'wsPort', constants_1.WS_PORTS[network]) + INCREMENT,
                    }];
        }
    });
}); };
