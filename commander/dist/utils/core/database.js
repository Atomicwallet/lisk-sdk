...
var isDbRunning = function(installDir, port) {
...
exports.initDB = function(installDir) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		var stderr;
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
				case 0:
					...
					return [
						4,
						worker_process_1.exec(PG_CTL + ' initdb --pgdata ' + DB_DATA, {
							cwd: installDir,
						}),
					];
				case 1:
...
exports.startDatabase = function(installDir, name) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
...
exports.createUser = function(installDir, network, name) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		...
		return tslib_1.__generator(this, function(_b) {
			switch (_b.label) {
				...
				case 1:
					(_a = _b.sent().config.components.storage),
						(user = _a.user),
					...
					return [
						...
						worker_process_1.exec(
							PG_BIN +
								...
								';\n\t\t\t' +
								PG_BIN +
								'/psql --quiet --dbname postgres --port ' +
								dbPort +
								' --command "ALTER USER ' +
								user +
								" WITH PASSWORD '" +
...
exports.createDatabase = function(installDir, network, name) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
...
exports.stopDatabase = function(installDir, name) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		var dbPort, isRunning, stderr;
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
...
exports.restoreSnapshot = function(
	installDir,
	network,
	snapshotFilePath,
	name,
