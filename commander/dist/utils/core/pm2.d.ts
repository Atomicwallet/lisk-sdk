...
export declare type ProcessStatus =
	| 'online'
	| 'stopping'
	| 'stopped'
	| 'launching'
...
export declare const registerApplication: (
	installPath: string,
	network: NETWORK,
	name: string,
	envConfig: object,
...
export declare const listApplication: () => Promise<
	ReadonlyArray<PM2ProcessInstance>
>;
export declare const describeApplication: (
	name: string,
