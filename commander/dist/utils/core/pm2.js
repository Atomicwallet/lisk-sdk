...
var startPM2 = function(installPath, network, name, envConfig) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		var apps;
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
				case 0:
					return [
						4,
						fs_extra_1.default.readJson(installPath + '/etc/pm2-lisk.json'),
					];
				case 1:
					apps = _a.sent().apps;
					return [
...
var restartPM2 = function(process) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		return tslib_1.__generator(this, function(_a) {
			return [
				2,
...
var describePM2 = function(process) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		return tslib_1.__generator(this, function(_a) {
			return [
				2,
				new Promise(function(resolve, reject) {
					pm2_1.describe(process, function(err, descs) {
						...
						var pDesc = descs.find(function(desc) {
							return desc.pid === process || desc.name === process;
						});
						if (!pDesc) {
...
exports.registerApplication = function(installPath, network, name, envConfig) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
				case 0:
...
exports.unRegisterApplication = function(name) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
				case 0:
...
exports.restartApplication = function(name) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
				case 0:
...
exports.stopApplication = function(name) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
				case 0:
...
var extractProcessDetails = function(appDesc) {
	var pm2_env = appDesc.pm2_env,
		monit = appDesc.monit,
		name = appDesc.name,
		pid = appDesc.pid;
	var _a = pm2_env,
		status = _a.status,
		pm_uptime = _a.pm_uptime,
		installationPath = _a.pm_cwd,
		version = _a.version,
		network = _a.LISK_NETWORK,
		dbPort = _a.LISK_DB_PORT,
		redisPort = _a.LISK_REDIS_PORT,
		httpPort = _a.LISK_HTTP_PORT,
		wsPort = _a.LISK_WS_PORT;
...
exports.listApplication = function() {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		var applications;
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
...
exports.describeApplication = function(name) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		var application;
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
