...
export declare const getPassphraseFromPrompt: ({
	displayName,
	shouldRepeat,
}: GetPassphraseFromPromptInputs) => Promise<string>;
export declare const getPassphraseFromEnvVariable: (
	key: string,
	displayName: string,
) => Promise<string>;
export declare const getPassphraseFromFile: (path: string) => Promise<string>;
export declare const getPassphraseFromSource: (
	source: string,
	{
		displayName,
	}: {
...
export declare const getPassphrase: (
	passphraseSource: string,
	options: object,
) => Promise<string>;
export declare const handleReadFileErrors: (
	path: string,
) => (error: Error) => never;
export declare const getDataFromFile: (path: string) => Promise<string>;
export declare const getData: (source?: string) => Promise<string>;
export {};
