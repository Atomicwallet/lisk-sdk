...
exports.getInputsFromSources = function(_a) {
	var passphraseInput = _a.passphrase,
		secondPassphraseInput = _a.secondPassphrase,
		passwordInput = _a.password,
		dataInput = _a.data;
			...
			switch (_g.label) {
				case 0:
					(_b = tslib_1.__read(
						...
						(passphraseIsRequired = _b[0]),
						(secondPassphraseIsRequired = _b[1]),
						(passwordIsRequired = _b[2]),
						(dataIsRequired = _b[3]);
					return [
						4,
						utils_1.getStdIn({
				...
				case 1:
					...
					return [
						4,
						utils_1.getPassphrase(passphraseInput.source, {
				...
				case 4:
					...
					if (
						!(
							typeof stdIn.secondPassphrase !== 'string' &&
							secondPassphraseInput
						)
					)
						return [3, 6];
					return [
						4,
						utils_1.getPassphrase(secondPassphraseInput.source, {
				...
				case 7:
					...
					passphraseErrors.forEach(function(errors) {
						if (errors.length > 0) {
							var passphraseWarning = errors
								.filter(function(error) {
									return error.code !== 'INVALID_MNEMONIC';
								})
					...
					return [
						4,
						utils_1.getPassphrase(passwordInput.source, {
