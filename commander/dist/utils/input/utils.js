...
exports.getStdIn = function (_a) {
    var _b = _a === void 0 ? {} : _a, passphraseIsRequired = _b.passphraseIsRequired, secondPassphraseIsRequired = _b.secondPassphraseIsRequired, passwordIsRequired = _b.passwordIsRequired, dataIsRequired = _b.dataIsRequired;
            ...
            readFromStd = new Promise(function (resolve, reject) {
                ...
                var handleClose = function () {
                    ...
                    var passphrase = passphraseIsRequired
                        ...
                        : undefined;
                    var secondPassphraseIndex = passphraseIndex + (passphrase !== undefined ? 1 : 0);
                    var secondPassphrase = secondPassphraseIsRequired
                        ? lines[secondPassphraseIndex]
                        : undefined;
                    var passwordIndex = secondPassphraseIndex + (secondPassphrase !== undefined ? 1 : 0);
                ...
                return rl.on('line', function (line) { return lines.push(line); }).on('close', handleClose);
            });
...
exports.getPassphraseFromPrompt = function (_a) {
    var displayName = _a.displayName, shouldRepeat = _a.shouldRepeat;
    return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _b = (_c.sent()), passphrase = _b.passphrase, passphraseRepeat = _b.passphraseRepeat;
...
exports.getPassphraseFromEnvVariable = function (key, displayName) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var passphrase;
...
exports.getPassphraseFromFile = function (path) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    return tslib_1.__generator(this, function (_a) {
...
exports.getPassphraseFromSource = function (source, _a) {
    ...
    return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_c) {
            _b = exports.splitSource(source), sourceType = _b.sourceType, sourceIdentifier = _b.sourceIdentifier;
            switch (sourceType) {
                case 'env':
                    return [2, exports.getPassphraseFromEnvVariable(sourceIdentifier, displayName)];
                case 'file':
...
exports.getPassphrase = function (passphraseSource, options) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var optionsWithDefaults;
    return tslib_1.__generator(this, function (_a) {
        optionsWithDefaults = tslib_1.__assign({ displayName: 'your secret passphrase' }, options);
        return [2, passphraseSource && passphraseSource !== 'prompt'
                ? exports.getPassphraseFromSource(passphraseSource, optionsWithDefaults)
                : exports.getPassphraseFromPrompt(optionsWithDefaults)];
    });
}); };
exports.handleReadFileErrors = function (path) { return function (error) {
    var message = error.message;
    if (message.match(/ENOENT/)) {
...
exports.getDataFromFile = function (path) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
    return [2, fs_1.default.readFileSync(path, 'utf8')];
}); }); };
exports.getData = function (source) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var _a, sourceType, path;
    return tslib_1.__generator(this, function (_b) {
        if (!source) {
            throw new error_1.ValidationError(ERROR_DATA_MISSING);
        }
        _a = exports.splitSource(source), sourceType = _a.sourceType, path = _a.sourceIdentifier;
        if (sourceType !== 'file') {
            throw new error_1.ValidationError(ERROR_DATA_SOURCE);
        }
        return [2, exports.getDataFromFile(path).catch(exports.handleReadFileErrors(path))];
    });
}); };
