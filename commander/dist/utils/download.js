...
exports.download = function(url, cacheDir) {
		...
		return tslib_1.__generator(this, function(_b) {
			switch (_b.label) {
				case 0:
					...
					(_a = commons_1.getDownloadedFileInfo(url, cacheDir)),
					...
					if (fs_extra_1.default.existsSync(filePath)) {
						if (
							commons_1.dateDiff(
								new Date(),
								fs_extra_1.default.statSync(filePath).birthtime,
...
exports.validateChecksum = function(url, cacheDir) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		...
		return tslib_1.__generator(this, function(_b) {
			switch (_b.label) {
				case 0:
					...
					return [
						4,
						worker_process_1.exec('shasum -c ' + fileName, {
							cwd: fileDir,
						}),
					];
				case 1:
...
exports.extract = function(filePath, fileName, outDir) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
...
exports.downloadAndValidate = function(url, cacheDir) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		return tslib_1.__generator(this, function(_a) {
			switch (_a.label) {
				case 0:
					return [4, exports.download(url, cacheDir)];
				case 1:
					_a.sent();
