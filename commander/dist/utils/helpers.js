...
exports.createErrorHandler = function (prefix) { return function (_a) {
...
exports.stdoutIsTTY = function () { return process.stdout.isTTY; };
exports.stdinIsTTY = function () { return process.stdin.isTTY; };
