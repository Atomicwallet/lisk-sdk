...
class PluginGenerator extends Generator {
    ...
    writing() {
        ...
        this.fs.copyTpl(`${this._templatePath}/src/app/plugins/plugin.ts`, this.destinationPath(`src/app/plugins/${this._alias}/${this._alias}.ts`), {
            alias: this._alias,
        ...
        this.fs.copyTpl(`${this._templatePath}/test/unit/plugins/plugin.spec.ts`, this.destinationPath(`test/unit/plugins/${this._alias}/${this._alias}.spec.ts`), {
            alias: this._alias,
            className: this._className,
        }, {}, { globOptions: { dot: true, ignore: ['.DS_Store'] } });
    }
