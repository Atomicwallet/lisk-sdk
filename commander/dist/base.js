...
var BaseCommand = (function (_super) {
    ...
    BaseCommand.prototype.print = function (result, readAgain) {
        if (readAgain === void 0) { readAgain = false; }
        if (readAgain) {
            this.userConfig = config_1.getConfig(process.env.XDG_CONFIG_HOME);
        }
        print_1.print(tslib_1.__assign({ json: this.userConfig.json, pretty: this.userConfig.pretty }, this.printFlags)).call(this, result);
    };
    BaseCommand.flags = {
