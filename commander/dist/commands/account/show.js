...
var processInput = function (_a) {
    ...
    var _b = lisk_cryptography_1.getKeys(passphrase), privateKey = _b.privateKey, publicKey = _b.publicKey;
...
var ShowCommand = (function (_super) {
    ...
    ShowCommand.flags = tslib_1.__assign({}, base_1.default.flags, { passphrase: command_1.flags.string(flags_1.flags.passphrase) });
    return ShowCommand;
}(base_1.default));
