		...
		if (i === dotNotationArray.length - 1) {
			if (obj === undefined) {
				throw new error_1.ValidationError(
					"Config file could not be written: property '" +
						dotNotationArray.join('.') +
...
var setArrayURL = function(config, dotNotation, _, inputs) {
	inputs.forEach(function(input) {
		var _a = url_1.default.parse(input),
