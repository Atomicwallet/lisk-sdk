...
var processInputs = function (encryptedPassphrase) { return function (_a) {
    var password = _a.password, data = _a.data;
    var encryptedPassphraseTarget = encryptedPassphrase || input_1.getFirstLineFromString(data);
    ...
    var encryptedPassphraseObject = lisk_cryptography_1.parseEncryptedPassphrase(encryptedPassphraseTarget);
    var passphrase = lisk_cryptography_1.decryptPassphraseWithPassword(encryptedPassphraseObject, password);
...
var DecryptCommand = (function (_super) {
    ...
    DecryptCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, args, _b, passphraseSource, passwordSource, encryptedPassphrase, inputs, result;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.parse(DecryptCommand), args = _a.args, _b = _a.flags, passphraseSource = _b.passphrase, passwordSource = _b.password;
    ...
    DecryptCommand.flags = tslib_1.__assign({}, base_1.default.flags, { password: command_1.flags.string(flags_1.flags.password), passphrase: command_1.flags.string({
