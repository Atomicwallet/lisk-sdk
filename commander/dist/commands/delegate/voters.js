...
var VotersCommand = (function (_super) {
    ...
    VotersCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, args, _b, limitStr, offsetStr, sortStr, usernamesStr, usernames, _c, limit, offset, sort, req, client, results;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this.parse(VotersCommand), args = _a.args, _b = _a.flags, limitStr = _b.limit, offsetStr = _b.offset, sortStr = _b.sort;
    ...
    VotersCommand.flags = tslib_1.__assign({}, base_1.default.flags, { limit: command_1.flags.string({
