...
var VOTES_SORT_FIELDS = constants_1.SORT_FIELDS.filter(function(field) {
	return !field.includes('publicKey');
});
...
var VotesCommand = (function(_super) {
	...
	VotesCommand.flags = tslib_1.__assign({}, base_1.default.flags, {
