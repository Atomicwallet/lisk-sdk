            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.print(instance);
                        return [3, 4];
                    case 2: return [4, pm2_1.listApplication()];
                    case 3:
                        instances = _a.sent();
                        if (!instances.length) {
                            this.log('Lisk Core instances not available, use lisk core:install --help');
                        }
                        else {
                            toDisplay_1 = [
                                'name',
                            ...
                            filtered = instances.map(function (instance) {
                                return Object.keys(instance).reduce(function (newObj, key) {
                                    ...
                                    return toDisplay_1.includes(key)
                                        ? tslib_1.__assign({}, newObj, (_a = {}, _a[key] = instance[key], _a)) : newObj;
                                }, {});
                            });
                            this.print(filtered);
                        }
