...
var validatePrerequisite = function(installPath) {
	if (!commons_1.isSupportedOS()) {
		throw new Error(
			'Lisk Core installation is not supported on ' + os.type() + '.',
		);
	}
...
var validateFlags = function(_a) {
	var network = _a.network,
		releaseUrl = _a['release-url'],
		snapshotUrl = _a['snapshot-url'];
...
var installOptions = function(_a, name) {
	var installationPath = _a['installation-path'],
		network = _a.network,
		releaseUrl = _a['release-url'],
		liskVersion = _a['lisk-version'];
		...
		return tslib_1.__generator(this, function(_c) {
			switch (_c.label) {
				...
				case 1:
					...
					return [
						4,
						release_1.getReleaseInfo(releaseUrl, network, installVersion),
					];
				case 2:
					(_b = _c.sent()),
						(version = _b.version),
						(liskTarUrl = _b.liskTarUrl),
						(liskTarSHA256Url = _b.liskTarSHA256Url);
					return [
						2,
						{
...
var InstallCommand = (function(_super) {
	...
	InstallCommand.prototype.run = function() {
		return tslib_1.__awaiter(this, void 0, void 0, function() {
			...
			return tslib_1.__generator(this, function(_c) {
				switch (_c.label) {
					case 0:
						(_a = this.parse(InstallCommand)),
							(args = _a.args),
							(flags = _a.flags);
						(_b = flags),
							(liskVersion = _b['lisk-version']),
							(noSnapshot = _b['no-snapshot']),
							(noStart = _b['no-start']),
							(network = _b.network),
							(snapshotUrl = _b['snapshot-url']);
						name = args.name;
												...
												return tslib_1.__awaiter(
													...
													function() {
														...
														return tslib_1.__generator(this, function(_a) {
															switch (_a.label) {
																case 0:
																	return [4, installOptions(flags, name)];
																case 1:
																	options = _a.sent();
																	ctx.options = options;
																	return [2];
														...
														return tslib_1.__generator(this, function(_a) {
															switch (_a.label) {
																case 0:
																	...
																	return [
																		4,
																		download_1.download(snapshotURL, cacheDir),
																	];
																case 1:
																	_a.sent();
																	_a.label = 2;
															...
															switch (_c.label) {
																case 0:
																	(_a = ctx.options),
																		...
																		(liskTarUrl = _a.liskTarUrl);
																	(_b = commons_1.getDownloadedFileInfo(
																		liskTarUrl,
																		cacheDir,
																	)),
														...
														return tslib_1.__generator(this, function(_a) {
															switch (_a.label) {
																case 0:
																	...
																	return [
																		4,
																		commons_1.generateEnvConfig(network),
																	];
																case 1:
																	envConfig = _a.sent();
																	return [
														...
														return tslib_1.__generator(this, function(_a) {
															switch (_a.label) {
																...
																case 1:
																	...
																	return [
																		4,
																		database_1.startDatabase(installDir, name),
																	];
																case 2:
																	_a.sent();
																	return [
																		4,
																		database_1.createUser(
																			installDir,
																			network,
																			name,
																		),
																...
																case 4:
																	...
																	filePath = commons_1.getDownloadedFileInfo(
																		snapshotURL,
																		cacheDir,
																	).filePath;
																	return [
																		4,
																		database_1.restoreSnapshot(
																			installDir,
																			network,
																			filePath,
																			name,
																...
																case 6:
																	return [
																		4,
																		database_1.stopDatabase(installDir, name),
																	];
																case 7:
																	_a.sent();
																	return [2];
	...
	InstallCommand.flags = {
		...
		'installation-path': command_1.flags.string(
			tslib_1.__assign({}, flags_1.flags.installationPath, {
		...
		'no-snapshot': command_1.flags.boolean(
			tslib_1.__assign({}, flags_1.flags.noSnapshot, {
				default: false,
				allowNo: false,
			}),
		),
		'no-start': command_1.flags.boolean(
			tslib_1.__assign({}, flags_1.flags.noStart, {
				default: false,
				allowNo: false,
			}),
		),
		network: command_1.flags.string(
			tslib_1.__assign({}, flags_1.flags.network, {
				default: constants_1.NETWORK.MAINNET,
				options: [
		...
		'snapshot-url': command_1.flags.string(
			tslib_1.__assign({}, flags_1.flags.snapshotUrl, {
				default: constants_1.SNAPSHOT_URL,
			}),
		),
	};
