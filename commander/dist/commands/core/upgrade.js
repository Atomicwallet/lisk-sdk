...
var UpgradeCommand = (function (_super) {
    ...
    UpgradeCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, args, flags, name, _b, liskVersion, releaseUrl, _c, installationPath, network, currentVersion, upgradeVersion, cacheDir, tasks;
            var _this = this;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this.parse(UpgradeCommand), args = _a.args, flags = _a.flags;
                        name = args.name;
                        _b = flags, liskVersion = _b["lisk-version"], releaseUrl = _b["release-url"];
                        return [4, pm2_1.describeApplication(name)];
                    case 1:
                        _c = _d.sent(), installationPath = _c.installationPath, network = _c.network, currentVersion = _c.version;
                        ...
                        tasks = new listr_1.default([
                            {
                                ...
                                task: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4, commons_1.validateVersion(network, upgradeVersion)];
                                            case 1:
                                                _a.sent();
                            ...
                            },
                            {
                                ...
                                task: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4, release_1.getReleaseInfo(releaseUrl, network, upgradeVersion)];
                                            case 1:
                                                liskTarUrl = (_a.sent()).liskTarUrl;
                                                return [4, download_1.downloadAndValidate(liskTarUrl, cacheDir)];
                                            case 2:
                                                _a.sent();
                                                return [2];
                                        }
                                    ...
                                    return new listr_1.default([
                                                ...
                                                return tslib_1.__generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            ...
                                                            return [4, cache_1.stopCache(installationPath, network, name)];
                                                        case 2:
                                                            _a.sent();
                                                            _a.label = 3;
                                                        case 3: return [4, database_1.stopDatabase(installationPath, name)];
                                                        case 4:
                                                            _a.sent();
                                        ...
                                        },
                                        {
                                            ...
                                            task: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                return tslib_1.__generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4, commons_1.backupLisk(installationPath)];
                                                        case 1:
                                                            _a.sent();
                                                            return [2];
                                                    }
                                                ...
                                                return tslib_1.__generator(this, function (_b) {
                                                    switch (_b.label) {
                                                        case 0:
                                                            ...
                                                            return [4, release_1.getReleaseInfo(releaseUrl, network, upgradeVersion)];
                                                        case 1:
                                                            liskTarUrl = (_b.sent()).liskTarUrl;
                                                            _a = commons_1.getDownloadedFileInfo(liskTarUrl, cacheDir), fileDir = _a.fileDir, fileName = _a.fileName;
                                                            return [4, download_1.extract(fileDir, fileName, installationPath)];
                                                        case 2:
                                                            _b.sent();
                                                            return [2];
                                                    }
                            ...
                            },
                            {
                                ...
                                task: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4, commons_1.upgradeLisk(installationPath, name, network, currentVersion)];
                                            case 1:
                                                _a.sent();
                                                return [2];
                                        }
                            ...
                            },
                            {
                                ...
                                task: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4, commons_1.generateEnvConfig(network)];
                                            case 1:
                                                envConfig = _a.sent();
                                                return [4, pm2_1.unRegisterApplication(name)];
                                            case 2:
                                                _a.sent();
                                                return [4, pm2_1.registerApplication(installationPath, network, name, envConfig)];
                                            case 3:
                                                _a.sent();
                                                return [2];
                                        }
                                    ...
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 2:
                                                _a.sent();
                                                _a.label = 3;
                                            case 3: return [4, database_1.startDatabase(installationPath, name)];
                                            case 4:
                                                _a.sent();
    ...
    UpgradeCommand.description = 'Upgrade an instance of Lisk Core to a specified or latest version.';
