...
var processInputs = function (nonce, senderPublicKey, message) { return function (_a) {
    ...
    return lisk_cryptography_1.decryptMessageWithPassphrase(targetMessage, nonce, passphrase, senderPublicKey);
}; };
var DecryptCommand = (function (_super) {
    ...
    DecryptCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, args, _b, passphraseSource, messageSource, senderPublicKey, nonce, message, inputs, result;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.parse(DecryptCommand), args = _a.args, _b = _a.flags, passphraseSource = _b.passphrase, messageSource = _b.message;
                        senderPublicKey = args.senderPublicKey, nonce = args.nonce, message = args.message;
    ...
    DecryptCommand.flags = tslib_1.__assign({}, base_1.default.flags, { passphrase: command_1.flags.string(flags_1.flags.passphrase), message: command_1.flags.string(flags_1.flags.message) });
