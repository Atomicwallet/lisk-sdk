...
var processInput = function (client, status, publicKey, password) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    return tslib_1.__generator(this, function (_a) {
        if (!password) {
            throw new error_1.ValidationError('No password was provided.');
        }
        return [2, client.node
                .updateForgingStatus({
                password: password,
                publicKey: publicKey,
...
var ForgingCommand = (function (_super) {
    ...
    ForgingCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.parse(ForgingCommand), args = _a.args, passwordSource = _a.flags.password;
    ...
    ForgingCommand.description = "Update the forging status of a Lisk Core instance.";
    ...
    ForgingCommand.flags = tslib_1.__assign({}, base_1.default.flags, { password: command_1.flags.string(flags_1.flags.password) });
