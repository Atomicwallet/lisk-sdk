...
var processInputs = function (amount, address, data) { return function (_a) {
...
var TransferCommand = (function (_super) {
    ...
    TransferCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, args, _b, passphraseSource, secondPassphraseSource, noSignature, dataString, amount, address, normalizedAmount, processFunction, noSignatureResult, inputs, result;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.parse(TransferCommand), args = _a.args, _b = _a.flags, passphraseSource = _b.passphrase, secondPassphraseSource = _b["second-passphrase"], noSignature = _b["no-signature"], dataString = _b.data;
                        amount = args.amount, address = args.address;
                        lisk_transactions_1.utils.validateAddress(address);
                        normalizedAmount = lisk_transactions_1.utils.convertLSKToBeddows(amount);
                        processFunction = processInputs(normalizedAmount, address, dataString);
                        if (noSignature) {
    ...
    TransferCommand.flags = tslib_1.__assign({}, base_1.default.flags, { passphrase: command_1.flags.string(flags_1.flags.passphrase), 'second-passphrase': command_1.flags.string(flags_1.flags.secondPassphrase), 'no-signature': command_1.flags.boolean(flags_1.flags.noSignature), data: command_1.flags.string(dataFlag) });
