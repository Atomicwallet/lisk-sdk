...
var processInputs = function (votes, unvotes) { return function (_a) {
...
var processVotesInput = function (votes) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
...
var processVotes = function (votes) {
    return votes
        ...
        .split(',')
        .filter(Boolean)
        .map(function (vote) { return vote.trim(); });
};
...
var VoteCommand = (function (_super) {
    ...
    VoteCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, passphraseSource, secondPassphraseSource, noSignature, votes, unvotes, processedVotesInput, _b, processedUnvotesInput, _c, validatedVotes, validatedUnvotes, processFunction, noSignatureResult, inputs, result;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this.parse(VoteCommand).flags, passphraseSource = _a.passphrase, secondPassphraseSource = _a["second-passphrase"], noSignature = _a["no-signature"], votes = _a.votes, unvotes = _a.unvotes;
                        if (!votes && !unvotes) {
