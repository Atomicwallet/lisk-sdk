...
var processInputs = function(lifetime, minimum, keysgroup) {
	return function(_a) {
...
var MultisignatureCommand = (function(_super) {
	...
	MultisignatureCommand.prototype.run = function() {
		return tslib_1.__awaiter(this, void 0, void 0, function() {
			...
			return tslib_1.__generator(this, function(_c) {
				switch (_c.label) {
					case 0:
						(_a = this.parse(MultisignatureCommand)),
							(args = _a.args),
							(_b = _a.flags),
	...
	MultisignatureCommand.flags = tslib_1.__assign({}, base_1.default.flags, {
