...
var multisignature_1 = tslib_1.__importDefault(require("./create/multisignature"));
var second_passphrase_1 = tslib_1.__importDefault(require("./create/second-passphrase"));
...
var options = Object.entries(typeNumberMap).reduce(function (accumulated, _a) {
    ...
    return tslib_1.__spread(accumulated, [
        key,
        value,
    ]);
}, []);
...
var CreateCommand = (function (_super) {
    ...
    CreateCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.parse(CreateCommand), argv = _a.argv, flags = _a.flags;
                        type = flags.type;
                        commandType = Object.keys(typeNumberMap).includes(type)
                            ? typeNumberMap[type]
                            : type;
                        resolvedFlags = Object.entries(flags).reduce(resolveFlags, []);
                        return [4, typeClassMap[commandType].run(tslib_1.__spread(argv, resolvedFlags))];
                    case 1:
                        _b.sent();
                        return [2];
                }
    ...
    CreateCommand.args = new Array(MAX_ARG_NUM).fill(0).map(function (i) { return ({
        name: i + "_arg",
    }); });
    ...
    CreateCommand.flags = tslib_1.__assign({}, base_1.default.flags, { type: command_1.flags.string({
            char: 't',
