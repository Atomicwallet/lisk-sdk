...
var GetCommand = (function(_super) {
	...
	GetCommand.prototype.run = function() {
		return tslib_1.__awaiter(this, void 0, void 0, function() {
			var _a,
				...
				client,
				reqTxnSenderId,
				stateSenderIdsResult,
				reqTransactionIds,
				txnStateIdsResult,
				reqWithSenderId,
				txnStateSenderResult,
				reqByLimitOffset,
				txnStateResult,
				reqTransactionIDs,
				idsResult,
			...
			return tslib_1.__generator(this, function(_c) {
				switch (_c.label) {
					case 0:
						(_a = this.parse(GetCommand)),
							(args = _a.args),
							(_b = _a.flags),
							(limit = _b.limit),
							(offset = _b.offset),
							(sort = _b.sort),
							(senderAddress = _b['sender-id']),
							(txnState = _b.state);
						idsStr = args.ids;
						...
						reqTxnSenderId = ids.map(function(id) {
							return {
								query: {
									limit: 1,
									id: id,
					...
					case 2:
						...
						reqTransactionIds = ids.map(function(id) {
							return {
								query: {
									limit: 1,
									id: id,
					...
					case 8:
						...
						return [
							4,
							query_1.query(client, 'transactions', reqTransactionIDs),
						];
					case 9:
						idsResult = _c.sent();
	...
	GetCommand.flags = tslib_1.__assign({}, base_1.default.flags, {
		state: command_1.flags.string(stateFlag),
		'sender-id': command_1.flags.string(senderIdFlag),
