...
var SignCommand = (function (_super) {
    ...
    SignCommand.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, args, _b, passphraseSource, secondPassphraseSource, transaction, transactionInput, _c, transactionObject, valid, _d, passphrase, secondPassphrase, result;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _a = this.parse(SignCommand), args = _a.args, _b = _a.flags, passphraseSource = _b.passphrase, secondPassphraseSource = _b["second-passphrase"];
                    ...
                    case 3:
                        _d = _e.sent(), passphrase = _d.passphrase, secondPassphrase = _d.secondPassphrase;
                        result = transactions.utils.prepareTransaction(transactionObject, passphrase, secondPassphrase);
                        this.print(result);
                        return [2];
                }
            });
    ...
    SignCommand.flags = tslib_1.__assign({}, base_1.default.flags, { passphrase: command_1.flags.string(flags_1.flags.passphrase), 'second-passphrase': command_1.flags.string(flags_1.flags.secondPassphrase) });
    return SignCommand;
}(base_1.default));
