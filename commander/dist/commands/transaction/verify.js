...
var secondPublicKeyDescription =
	'Specifies a source for providing a second public key to the command. The second public key must be provided via this option. Sources must be one of `file` or `stdin`. In the case of `file`, a corresponding identifier must also be provided.\n\n\tNote: if both transaction and second public key are passed via stdin, the transaction must be the first line.\n\n\tExamples:\n\t- --second-public-key file:/path/to/my/message.txt\n\t- --second-public-key 790049f919979d5ea42cca7b7aa0812cbae8f0db3ee39c1fe3cef18e25b67951\n';
...
var processSecondPublicKey = function(secondPublicKey) {
	return tslib_1.__awaiter(_this, void 0, void 0, function() {
		return tslib_1.__generator(this, function(_a) {
			return [
				2,
				secondPublicKey.includes(':')
					? utils_1.getData(secondPublicKey)
					: secondPublicKey,
			];
		});
	});
...
var VerifyCommand = (function(_super) {
	...
	VerifyCommand.prototype.run = function() {
		return tslib_1.__awaiter(this, void 0, void 0, function() {
			...
			return tslib_1.__generator(this, function(_d) {
				switch (_d.label) {
					case 0:
						(_a = this.parse(VerifyCommand)),
							(args = _a.args),
							(secondPublicKeySource = _a.flags['second-public-key']);
					...
					case 5:
						secondPublicKey = _c;
						verified = transactions.utils.verifyTransaction(
							transactionObject,
							secondPublicKey,
						);
	...
	VerifyCommand.flags = tslib_1.__assign({}, base_1.default.flags, {
		'second-public-key': command_1.flags.string({
